    ...
    def __init__(self, render=True):
        if config.fullscreen:
            ...
            if render :
                ...
                self.surface = pygame.display.set_mode(config.resolution, pygame.FULLSCREEN, flags=pygame.HIDDEN)
        else:
            if render :
                self.surface = pygame.display.set_mode(config.resolution)
            else:
                self.surface = pygame.display.set_mode(config.resolution, flags=pygame.HIDDEN)
